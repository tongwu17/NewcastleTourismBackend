...
This is the backend code for the Newcastle Tourism project, which showcases attractions and tourism-related services in Newcastle, a historic city in the UK. It is developed using a robust technology stack including Java with Spring Boot framework, and MySQL for database management. Refer to the link https://github.com/tongwu17/NewcastleTourismFrontend, which is the frontend for this project.
